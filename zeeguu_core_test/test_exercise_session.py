...
from zeeguu_core_test.rules.user_exercise_session_rule import \
    ExerciseSessionRule
...
class UserExerciseSessionTest(ModelTestMixIn, TestCase):
    ...
    def test__get_exercise_session1(self):
        ...
        assert UserExerciseSession._find_most_recent_session(self.ex_session1.user_id, session)
    ...
    def test__get_exercise_session2(self):
        ...
        resulting_exercise_session = UserExerciseSession._find_most_recent_session(self.ex_session1.user_id, session)
    ...
    def test__update_last_use(self):
        ...
        updated_session = self.ex_session1._update_last_action_time(session, current_time)
    ...
    def test__close_session(self):
        assert self.ex_session1 == self.ex_session1._close_exercise_session(session)
    ...
    def test__update_exercise_session_scenario1(self):
        ...
        updated_session = UserExerciseSession.update_exercise_session(self.exercises[0], session)
    ...
    def test__update_exercise_session_scenario2(self):
        ...
        self.exercises[0].time = self.CURRENT_TIME
        resulting_exercise_session = UserExerciseSession.update_exercise_session(self.exercises[0], session)
