#!/usr/bin/env python
import zeeguu_core
from zeeguu_core.model import User, ExerciseOutcome
...
if __name__ == "__main__":
    ...
    logs.logp(f'correct -> wrong: {len(correct_at_first_but_incorrect_at_end)}')
    logs.logp(f'correct -> correct: {correct_from_first_to_last}')

    logs.logp(f'wrong -> correct: {len(wrong_first_time_but_correct_at_end)}')
